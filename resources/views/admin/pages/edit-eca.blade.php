    ...
    <div class="admin-shell stack">
        ...
        <form id="page-edit-form" method="POST" action="{{ route('admin.pages.update', $page) }}" class="stack" enctype="multipart/form-data">
            ...
            <section class="section-card">
                <div class="section-header">
                    <div>
                        ...
                        <h3 class="section-title">Configuracion base de ECA</h3>
            ...
            <section class="section-card">
                ...
                <div class="grid grid-2">
                    <div class="field" style="grid-column:1/-1;"><label>Badge</label><input type="text" name="eca_hero[badge]" value="{{ old('eca_hero.badge', $hero['badge'] ?? '') }}"></div>
                    ...
                    <div class="field"><label>URL boton principal</label><input type="text" name="eca_hero[primary_button_url]" value="{{ old('eca_hero.primary_button_url', $hero['primary_button_url'] ?? '') }}"></div>
                    ...
                    <div class="field"><label>URL boton secundario</label><input type="text" name="eca_hero[secondary_button_url]" value="{{ old('eca_hero.secondary_button_url', $hero['secondary_button_url'] ?? '') }}"></div>
                    <div class="field"><label>Icono visual</label><input type="text" name="eca_hero[visual_icon]" value="{{ old('eca_hero.visual_icon', $hero['visual_icon'] ?? '') }}"></div>
            ...
            <section class="section-card">
                ...
                <div class="grid grid-2">
                    ...
                    <div class="field"><label>Boton CTA</label><input type="text" name="eca_rates[primary_button_label]" value="{{ old('eca_rates.primary_button_label', $rates['settings']['primary_button_label'] ?? '') }}"></div>
                    <div class="field"><label>URL CTA</label><input type="text" name="eca_rates[primary_button_url]" value="{{ old('eca_rates.primary_button_url', $rates['settings']['primary_button_url'] ?? '') }}"></div>
                </div>
                <div class="subpanel">
            ...
            <section class="section-card">
                ...
                <div class="grid grid-2">
                    ...
                    <div class="field"><label>URL boton</label><input type="text" name="eca_cta[button_url]" value="{{ old('eca_cta.button_url', $cta['button_url'] ?? '') }}"></div>
                </div>
            </section>

            <div class="save-dock">
                <div style="flex:1;">
                    <strong style="display:block; margin-bottom:4px;">Guardar pagina ECA</strong>

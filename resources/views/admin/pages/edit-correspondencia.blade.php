...
@php
    $hero = $editorData['correspondencia_hero']['settings'] ?? [];
    $intro = $editorData['correspondencia_intro'];
    $rates = $editorData['correspondencia_rates'];
    $coverage = $editorData['correspondencia_coverage'];
    $solutions = $editorData['correspondencia_solutions'];
    $cta = $editorData['correspondencia_cta']['settings'] ?? [];
    ...
    <div class="admin-shell stack">
        ...
        <form id="page-edit-form" method="POST" action="{{ route('admin.pages.update', $page) }}" class="stack" enctype="multipart/form-data">
            ...
            <section class="section-card">
                ...
                <div class="grid grid-2">
                    <div class="field"><label>Eyebrow</label><input type="text" name="correspondencia_intro[eyebrow]" value="{{ old('correspondencia_intro.eyebrow', $intro['settings']['eyebrow'] ?? '') }}"></div>
                    <div class="field"><label>Titulo</label><input type="text" name="correspondencia_intro[title]" value="{{ old('correspondencia_intro.title', $intro['settings']['title'] ?? '') }}"></div>
                    <div class="field" style="grid-column:1/-1;"><label>Parrafo 1</label><textarea class="field-small" name="correspondencia_intro[paragraph_one]">{{ old('correspondencia_intro.paragraph_one', $intro['settings']['paragraph_one'] ?? '') }}</textarea></div>
                    <div class="field" style="grid-column:1/-1;"><label>Parrafo 2</label><textarea class="field-small" name="correspondencia_intro[paragraph_two]">{{ old('correspondencia_intro.paragraph_two', $intro['settings']['paragraph_two'] ?? '') }}</textarea></div>
                </div>
                <div class="subpanel">
                    ...
                    <div class="stack" data-collection data-base="correspondencia_intro[items]" data-template="eca-simple-template">
                        <div class="stack" data-rows>
                            @foreach (old('correspondencia_intro.items', $intro['items'] ?? []) as $item)
            ...
            <section class="section-card">
                ...
                <div class="grid grid-2">
                    <div class="field"><label>Titulo</label><input type="text" name="correspondencia_rates[title]" value="{{ old('correspondencia_rates.title', $rates['settings']['title'] ?? '') }}"></div>
                ...
                <div class="subpanel">
                    ...
                    <div class="stack" data-collection data-base="correspondencia_rates[items]" data-template="eca-stat-template">
                        <div class="stack" data-rows>
                            @foreach (old('correspondencia_rates.items', $rates['items'] ?? []) as $item)
                                <div class="repeater-card" data-row>
            ...
            <section class="section-card">
                ...
                <div class="grid grid-2">
                    <div class="field"><label>Titulo</label><input type="text" name="correspondencia_coverage[title]" value="{{ old('correspondencia_coverage.title', $coverage['settings']['title'] ?? '') }}"></div>
                    <div class="field"><label>Subtitulo</label><input type="text" name="correspondencia_coverage[subtitle]" value="{{ old('correspondencia_coverage.subtitle', $coverage['settings']['subtitle'] ?? '') }}"></div>
                    <div class="field"><label>Titulo nota</label><input type="text" name="correspondencia_coverage[note_title]" value="{{ old('correspondencia_coverage.note_title', $coverage['settings']['note_title'] ?? '') }}"></div>
                    <div class="field"><label>Texto nota</label><input type="text" name="correspondencia_coverage[note_text]" value="{{ old('correspondencia_coverage.note_text', $coverage['settings']['note_text'] ?? '') }}"></div>
                </div>
                <div class="subpanel">
                    ...
                    <div class="stack" data-collection data-base="correspondencia_coverage[items]" data-template="eca-coverage-template">
                        <div class="stack" data-rows>
                            @foreach (old('correspondencia_coverage.items', $coverage['items'] ?? []) as $item)
                                <div class="repeater-card" data-row>
                                    <div class="toolbar"><div class="actions"><span class="drag-handle" data-drag>::</span><strong>{{ $item['title'] ?? 'Tarjeta' }}</strong></div><button type="button" class="button button-danger" data-remove-row>Eliminar</button></div>
                                    <div class="grid grid-2" style="margin-top:12px;">
            ...
            <section class="section-card">
                ...
                <div class="grid grid-2">
                    <div class="field"><label>Titulo</label><input type="text" name="correspondencia_solutions[title]" value="{{ old('correspondencia_solutions.title', $solutions['settings']['title'] ?? '') }}"></div>
                    <div class="field"><label>Subtitulo</label><input type="text" name="correspondencia_solutions[subtitle]" value="{{ old('correspondencia_solutions.subtitle', $solutions['settings']['subtitle'] ?? '') }}"></div>
                </div>
                <div class="subpanel">
                    ...
                    <div class="stack" data-collection data-base="correspondencia_solutions[items]" data-template="ems-card-template">
                        <div class="stack" data-rows>
                            @foreach (old('correspondencia_solutions.items', $solutions['items'] ?? []) as $item)
                                <div class="repeater-card" data-row>
                                    <div class="toolbar"><div class="actions"><span class="drag-handle" data-drag>::</span><strong>{{ $item['title'] ?? 'Tarjeta' }}</strong></div><button type="button" class="button button-danger" data-remove-row>Eliminar</button></div>
                                    <div class="grid grid-2" style="margin-top:12px;">
                                        <div class="field"><label>Titulo</label><input type="text" data-field="title" value="{{ $item['title'] ?? '' }}"></div>
            ...
            <section class="section-card">
                ...
                <div class="grid grid-2">
                    <div class="field"><label>Titulo</label><input type="text" name="correspondencia_cta[title]" value="{{ old('correspondencia_cta.title', $cta['title'] ?? '') }}"></div>
                    <div class="field"><label>Texto principal</label><input type="text" name="correspondencia_cta[text]" value="{{ old('correspondencia_cta.text', $cta['text'] ?? '') }}"></div>
                    <div class="field"><label>Label telefono</label><input type="text" name="correspondencia_cta[phone_label]" value="{{ old('correspondencia_cta.phone_label', $cta['phone_label'] ?? '') }}"></div>
                    <div class="field"><label>Valor telefono</label><input type="text" name="correspondencia_cta[phone_value]" value="{{ old('correspondencia_cta.phone_value', $cta['phone_value'] ?? '') }}"></div>
                    <div class="field"><label>Label email</label><input type="text" name="correspondencia_cta[email_label]" value="{{ old('correspondencia_cta.email_label', $cta['email_label'] ?? '') }}"></div>
                    <div class="field"><label>Valor email</label><input type="text" name="correspondencia_cta[email_value]" value="{{ old('correspondencia_cta.email_value', $cta['email_value'] ?? '') }}"></div>
                    <div class="field"><label>Label direccion</label><input type="text" name="correspondencia_cta[address_label]" value="{{ old('correspondencia_cta.address_label', $cta['address_label'] ?? '') }}"></div>
                    <div class="field"><label>Valor direccion</label><input type="text" name="correspondencia_cta[address_value]" value="{{ old('correspondencia_cta.address_value', $cta['address_value'] ?? '') }}"></div>
                    <div class="field"><label>Texto inferior</label><input type="text" name="correspondencia_cta[footnote]" value="{{ old('correspondencia_cta.footnote', $cta['footnote'] ?? '') }}"></div>
                    <div class="field"><label>Titulo QR</label><input type="text" name="correspondencia_cta[qr_title]" value="{{ old('correspondencia_cta.qr_title', $cta['qr_title'] ?? '') }}"></div>
                    <div class="field"><label>Texto QR</label><input type="text" name="correspondencia_cta[qr_text]" value="{{ old('correspondencia_cta.qr_text', $cta['qr_text'] ?? '') }}"></div>
